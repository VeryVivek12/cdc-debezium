...
public class MongoCDCKStream {
    ...
    public static void main(String[] args) {
        ...
        String source = "dbserver1.inventory.customers";
        String dest = "product";
        String kafka = "kafka:9092";
        final UpdateStrategy strategy = UpdateStrategy.BEFORE_AFTER;

        Properties props = new Properties();
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, source);
